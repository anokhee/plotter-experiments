  ...
  constructor(x, y, sides, radius, seed) {
    ...
    this.hairVals = {
      ...
      fringe: {
        ...
        waveFrequency: 0.08,
        waveAmplitude: 5,
        curve: { x1: this.radius * 0.5, y1: 10, x2: this.radius * 0.5, y2: 5 },
      },
      texture: {
        amount: 20,
      },
  ...
  randomizeVals() {
    ...
    if (this.hairType === "lines") {
      ...
      this.hairVals.position.bottom = Math.floor(
        random(Math.floor(this.sides * 0.2), Math.floor(this.sides * 0.7))
      );
      ...
      this.hairVals.shape.y1 = random(-shapex1, shapex1 * 1.5);
      this.hairVals.shape.x1 = random(shapex1, shapex1);
      this.hairVals.shape.y2 = random(-shapex1, shapex1 * 1.5);
